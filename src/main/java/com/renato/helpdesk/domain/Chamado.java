package com.renato.helpdesk.domain;
...
public class Chamado {
	...
	private Prioridade prioriudade;
	...
	public Chamado(Integer id, Prioridade prioriudade, Status status, String titulo, String observacoes,
	...
	public Prioridade getPrioriudade() {
		return prioriudade;
	}

	public void setPrioriudade(Prioridade prioriudade) {
		this.prioriudade = prioriudade;
	}
